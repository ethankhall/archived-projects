...
public class HourlyLineItemTest {
    ...
    public void testChangeHourValue() throws Exception {
        ...
        assertThat(lineItem.getAmount(0)).isEqualTo(BigDecimal.ONE.setScale(3));
        lineItem.setHours(100.234);
        lineItem.setHourlyRate(BigDecimal.valueOf(2.1));
        assertThat(lineItem.getAmount(0)).isEqualTo(BigDecimal.valueOf(2.1 * 100.234).setScale(3, RoundingMode.HALF_EVEN));
    }
}
